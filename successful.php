...
<title>Successful | Klinsheet Job Portal</title>
    ...
    <div class="dashboard_nav_menu">
        ...
        <div class="dashboard_nav_menu3">
            ...
            <div id="dashboard_nav_menu32">
                <div id="dash_userimg"><img src="./dist/images/d-user.png" class="img-fluid"></div>
                <div id="dash_username">Hello Gloria!</div>                
            </div>
        </div>
    </div>    
